...
The checks are driven through [fastlane](./fastlane/Fastfile), which groups the Gradle tasks behind them. Prepare it once with `mise install && bundle install`, then run one of these with `bundle exec <lane>`.
